...
module.exports = {
    ...
    'Engine Parts Home Page Test': function (browser) {
        ...
        browser.waitForElementVisible({ selector: 'a[href="/parts/aftermarket-products/engine-parts/_/N-2497405862"]' }, 'Engine Parts');

        browser.click({ selector: 'a[href="/parts/aftermarket-products/engine-parts/_/N-2497405862"]' }, 'open Engine Parts');
        ...
        browser.waitForElementVisible({ selector: '/html/body/app-root/div/div[2]/div[2]/app-dynamic-route-component/app-template/app-page-slot/section/app-template/app-page-slot/section/app-template/app-two-column-page/section/div[2]/div[1]/app-cartridges/app-cartridge[2]/app-content-slot-left/app-cartridges/app-cartridge/app-guided-navigation/div/div[1]/app-refinement-menu/ul/li[8]/strong/u/a', locateStrategy: 'xpath' }, 'View less');

        // checking button ' ENGINE PARTS '
        browser.waitForElementVisible({ selector: '/html/body/app-root/div/div[2]/div[2]/app-dynamic-route-component/app-template/app-page-slot/section/app-template/app-page-slot/section/app-template/app-two-column-page/section/div[2]/div[2]/app-cartridges/app-cartridge[1]/app-h1/h1', locateStrategy: 'xpath' }, 'ENGINE PARTS');

        // checking button ' results for "Engine Parts" '
        browser.waitForElementVisible({ selector: '/html/body/app-root/div/div[2]/div[2]/app-dynamic-route-component/app-template/app-page-slot/section/app-template/app-page-slot/section/app-template/app-two-column-page/section/div[2]/div[2]/app-cartridges/app-cartridge[1]/app-h1/h1', locateStrategy: 'xpath' }, 'results for "Engine Parts"');
